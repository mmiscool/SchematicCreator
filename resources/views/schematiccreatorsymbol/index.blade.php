    ...
    width: auto;">
                    ...
                    <td>
                        <a data-toggle="modal" data-target="#myModal" class='delete btn btn-danger btn-xs'
                           data-link="/schematiccreatorsymbol/{!!$schematiccreatorsymbol->id!!}/deleteMsg"><i
                                    class='fa fa-trash'> delete</i></a>
                        <a href='#' class='viewEdit btn btn-primary btn-xs'
                           data-link='/schematiccreatorsymbol/{!!$schematiccreatorsymbol->id!!}/edit'><i
                                    class='fa fa-edit'> edit</i></a>
                        <a href='#' class='viewShow btn btn-warning btn-xs'
                           data-link='/schematiccreatorsymbol/{!!$schematiccreatorsymbol->id!!}'><i class='fa fa-eye'>
                                info</i></a>
                        <textarea id="symbolData-{!!$schematiccreatorsymbol->id!!}" name="symbolData" type="text"
                                  style="display:none;">{!!$schematiccreatorsymbol->symbolData!!}</textarea>

                        <script>
                            bla = document.getElementById("symbolData-{!!$schematiccreatorsymbol->id!!}").value;
                            if (bla !== "") BrowserStorageStore("Symbol", "{!!$schematiccreatorsymbol->id!!}", "Layout", bla);
                        </script>
                    </td>
                </tr>
